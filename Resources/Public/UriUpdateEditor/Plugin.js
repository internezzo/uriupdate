...
var TextField = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            ...
            var slug = (0, _slugify2.default)(titleValue);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactUiComponents.IconButton, {
                        ...
                        style: "",
                        hoverStyle: "clean",
                        title: i18nRegistry.translate("Internezzo.UriUpdate:Main:js.sync")
                    })
                )
            );
        }
...
var _UriUpdateEditor = __webpack_require__(/*! ./UriUpdateEditor */ "./src/UriUpdateEditor.js");

var _UriUpdateEditor2 = _interopRequireDefault(_UriUpdateEditor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)("Internezzo.UriUpdate:UriUpdateEditor", {}, function (globalRegistry) {
    var editorsRegistry = globalRegistry.get("inspector").get("editors");
    editorsRegistry.set("Internezzo.UriUpdate/UriUpdateEditor", {
        component: _UriUpdateEditor2.default
    });
});
